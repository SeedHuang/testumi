import { IconWidget, usePrefix } from '@dn/react';
                ...
                <InputItems vertical>
                    <Field
                        ...
                        dataSource={[
                            ...
                            {
                                label: (
                                    <IconWidget infer="FlexDirectionColumn" />
                                ),
                                value: 'column',
                            },
                        ]}
                    ...
                    <Field
                        ...
                        reactions={(field) => {
                            field.decorator[1].title = `Flex Wrap : ${
                                field.value || ''
                            }`;
                        }}
                        decorator={[InputItems.Item]}
                    ...
                    <Field
                        ...
                        dataSource={[
                            {
                                label: (
                                    <IconWidget infer="FlexAlignContentCenter" />
                                ),
                                value: 'center',
                            },
                            {
                                label: (
                                    <IconWidget infer="FlexAlignContentStart" />
                                ),
                                value: 'flex-start',
                            },
                            {
                                label: (
                                    <IconWidget infer="FlexAlignContentEnd" />
                                ),
                                value: 'flex-end',
                            },
                            {
                                label: (
                                    <IconWidget infer="FlexAlignContentSpaceAround" />
                                ),
                                value: 'space-around',
                            },
                            {
                                label: (
                                    <IconWidget infer="FlexAlignContentSpaceBetween" />
                                ),
                                value: 'space-between',
                            },
                            {
                                label: (
                                    <IconWidget infer="FlexAlignContentStretch" />
                                ),
                                value: 'stretch',
                            },
                        ]}
                    ...
                    <Field
                        ...
                        dataSource={[
                            ...
                            {
                                label: (
                                    <IconWidget infer="FlexJustifySpaceAround" />
                                ),
                                value: 'space-around',
                            },
                            {
                                label: (
                                    <IconWidget infer="FlexJustifySpaceBetween" />
                                ),
                                value: 'space-between',
                            },
                            {
                                label: (
                                    <IconWidget infer="FlexJustifySpaceEvenly" />
                                ),
                                value: 'space-evenly',
                            },
                        ]}
                    ...
                    <Field
                        ...
                        dataSource={[
                            {
                                label: (
                                    <IconWidget infer="FlexAlignItemsCenter" />
                                ),
                                value: 'center',
                            },
                            {
                                label: (
                                    <IconWidget infer="FlexAlignItemsStart" />
                                ),
                                value: 'flex-start',
                            },
                            {
                            ...
                            {
                                label: (
                                    <IconWidget infer="FlexAlignItemsStretch" />
                                ),
                                value: 'stretch',
                            },
                            {
                                label: (
                                    <IconWidget infer="FlexAlignItemsBaseline" />
                                ),
                                value: 'baseline',
                            },
                        ]}
