                        ...
                        <InputItems.Item icon="FontStyle" width="50%">
                            <Field
                                ...
                                dataSource={[
                                    {
                                        label: (
                                            <IconWidget infer="NormalFontStyle" />
                                        ),
                                        value: 'normal',
                                    },
                                    {
                                        label: (
                                            <IconWidget infer="ItalicFontStyle" />
                                        ),
                                        value: 'italic',
                                    },
                                ]}
                        ...
                        <InputItems.Item icon="TextAlign">
                            <Field
                                ...
                                dataSource={[
                                    {
                                        label: (
                                            <IconWidget infer="TextAlignLeft" />
                                        ),
                                        value: 'left',
                                    },
                                    {
                                        label: (
                                            <IconWidget infer="TextAlignCenter" />
                                        ),
                                        value: 'center',
                                    },
                                    {
                                        label: (
                                            <IconWidget infer="TextAlignRight" />
                                        ),
                                        value: 'right',
                                    },
                                    {
                                        label: (
                                            <IconWidget infer="TextAlignJustify" />
                                        ),
                                        value: 'justify',
                                    },
                                ]}
                        ...
                        <InputItems.Item icon="TextDecoration">
                            <Field
                                ...
                                dataSource={[
                                    ...
                                    {
                                        label: (
                                            <IconWidget infer="TextUnderline" />
                                        ),
                                        value: 'underline',
                                    },
                                    {
                                        label: (
                                            <IconWidget infer="TextLineThrough" />
                                        ),
                                        value: 'line-through',
                                    },
                                ]}
