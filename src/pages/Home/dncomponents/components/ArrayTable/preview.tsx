                ...
                >
                    {columns.map((node) => {
                        const children = node.children.map((child) => {
                            return (
                                <TreeNodeWidget node={child} key={child.id} />
                            );
                        });
            ...
            <LoadTemplate
                actions={[
                    ...
                    },
                    {
                        ...
                        onClick: () => {
                            ...
                            if (sortNode) {
                                ...
                                ensureObjectItemsNode(node).prepend(
                                    tableColumn,
                                );
                            }
                        },
                    },
                    {
                        ...
                        icon: 'AddColumn',
                        onClick: () => {
                            const operationNode = findNodeByComponentPath(
                                node,
                                [
                                    'ArrayTable',
                                    '*',
                    ...
                    },
                    {
                        ...
                        icon: 'AddOperation',
                        onClick: () => {
                            const oldOperationNode = findNodeByComponentPath(
                                node,
                                [
                                    'ArrayTable',
                                    '*',
                            ...
                            const oldAdditionNode = findNodeByComponentPath(
                                node,
                                ['ArrayTable', 'ArrayTable.Addition'],
                            );
                            if (!oldOperationNode) {
                                const operationNode = new TreeNode({
                                    componentName: 'Field',
